...
INSERT INTO migrations (filename, applied_at) VALUES ('002_add_multi_admin.sql', CURRENT_TIMESTAMP);
...
ALTER TABLE audit_log ADD COLUMN target_admin_id INT UNSIGNED NULL AFTER admin_id;
