-- Migration: Comprehensive settings system (SQLite variant)
...
CREATE INDEX idx_category ON settings_registry(category);
CREATE INDEX idx_advanced ON settings_registry(is_advanced);
