...
// If config is missing or database fails, show a helpful setup diagnostic page
$config = null;
$pdo = null;
$bootstrapError = null;

if (!is_file($configPath)) {
    $bootstrapError = 'config_missing';
} else {
    ...
    try {
        ...
        $bootstrapError = 'db_connection_failed';
    }
}

if (!defined('APP_SEARCH_PAGE_SIZE')) {
    // Constants weren't defined due to early error, define defaults
    define('APP_SEARCH_PAGE_SIZE', 20);
    define('APP_CACHE_TTL_SHORT', 600);
    define('APP_CACHE_TTL_MEDIUM', 3600);
    define('APP_CACHE_TTL_LONG', 86400);
    define('APP_MAX_PAGINATION_PAGE', 1000);
    define('APP_MAX_SEARCH_RESULTS', 10000);
    define('APP_PASSWORD_MIN_LENGTH', 12);
    define('APP_STRIPE_KEY_PREFIX_PUB', 'pk_');
