...
<body>
<?php if (function_exists('dev_mode_enabled') && dev_mode_enabled()): ?>
  <div class="dev-mode-banner">
    DEV MODE — login is bypassed. Set <code>security.dev_mode</code> to <code>false</code> in <code>config/config.php</code> before this goes anywhere near a real domain.
  </div>
<?php endif; ?>
